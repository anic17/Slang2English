...
for %%A in (imo tbh idc idk idfk ig ik ikr lol lmfao lmao yh y ye yo tf wtf k cya tho ur r u w8 m8 l8 r8 gn gf bf smth tmrw smh p2w skid yall kys alr aight c wbu btw im youre atm 's boi jk fck fcking fu ftw rn) do (
    set "slang[!c_sl!]=%%A"
    set /a c_sl+=1
)
...
for %%A in (
    ...
    "fuck" "fucking" "fuck you" "for the win" "right now"
    ) do (
    set "fe[!c_fe!]=%%~A"
    set /a c_fe+=1
)
